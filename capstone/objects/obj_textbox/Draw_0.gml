...
if (setup == false)
{
	...
	{
		//find how many characters are on each page and store that rumber in the "text_length" array
		...
		for(var c = 0; c < text_length[p]; c++)
		{
			...
			//add to the x and y based on the new info
...
if(draw_char == text_length[page] && page == (page_number - 1))
{
	...
	for (var op = 0; op < option_number; op++)
	{
		...
		draw_sprite_ext(txtb_spr[page], txtb_img, _txtb_x + _space, _txtb_y - _op_space * option_number + _op_space * op, _o_w/txtb_spr_w, (_op_space - 1)/txtb_spr_h, 0, c_white, 1);
		//the arrow
		if(option_pos == op)
		{
